...
module.exports = {
    ...
    async run(client, interaction, args) {
        ...
        if (interaction.guild.id != "1093653560543158282") return interaction.editReply({content: "Cet utilitaire n'est pas disponible dans ce serveur", ephemeral: true})
        ...
        let liste_desc = { "discord" : "<:discord:1279875925290389525> : Être membre du Discord", "twitch" : "<:twitch:1279875952154902598> : Être follow à la chaîne Twitch", "halloween" : "<:pumpkin:1279074205094379540> : Avoir participé à l'event halloween 2023", "vip" : "<:vip:1279875960761614348> : Être VIP", "fonda" : "<:fonda:1279875944991166526> : Être fondateur ", "sub" : "<:sub:1279875982710276096> : Être sub à la chaîne", "mod" : "<:mod:1279875971368878101> : Faire parti du staff" }   
